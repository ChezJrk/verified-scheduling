...
Makefilee.coq.conf: 
	coq_makefile -R . ATL Convolution.v GatherScatter.v Im2col.v Blur.v -o Makefilee.coq

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code he may need
-include Makefilee.coq.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in Makefilee.coq.local once and for all.
...
# put in Makefilee.coq.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in Makefilee.coq.local
#
###############################################################################
...
#
# There rules can be extended in Makefilee.coq.local
...
# extension points and Makefilee.coq.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in Makefilee.coq.local or include Makefilee.coq.conf)
	@echo 'LOCAL = $(LOCAL)'
	@echo 'COQLIB = $(COQLIB)'
	@echo 'DOCDIR = $(DOCDIR)'
...
# file you can extend the merlin-hook target in Makefilee.coq.local
.merlin:
	$(SHOW)'FILL .merlin'
