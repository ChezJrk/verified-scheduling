...
Makefileg.coq.conf: 
	coq_makefile -R ../atl ATL -R ../../examples Examples -R . Codegen IdentParsing.v Normalize.v CheckSafe.v NatToString.v IntToString.v CodeGen.v -o Makefileg.coq

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code he may need
-include Makefileg.coq.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in Makefileg.coq.local once and for all.
...
# put in Makefileg.coq.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in Makefileg.coq.local
#
###############################################################################
...
#
# There rules can be extended in Makefileg.coq.local
...
# extension points and Makefileg.coq.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in Makefileg.coq.local or include Makefileg.coq.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in Makefileg.coq.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create Makefileg.coq.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include Makefileg.coq.local-late
