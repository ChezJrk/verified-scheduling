...
Makefilel.coq.conf: 
	coq_makefile -R . ATL GenLib.v -o Makefilel.coq

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code he may need
-include Makefilel.coq.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in Makefilel.coq.local once and for all.
...
# put in Makefilel.coq.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in Makefilel.coq.local
#
###############################################################################
...
#
# There rules can be extended in Makefilel.coq.local
...
# extension points and Makefilel.coq.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in Makefilel.coq.local or include Makefilel.coq.conf)
	@echo 'LOCAL = $(LOCAL)'
	@echo 'COQLIB = $(COQLIB)'
	@echo 'DOCDIR = $(DOCDIR)'
...
# file you can extend the merlin-hook target in Makefilel.coq.local
.merlin:
	$(SHOW)'FILL .merlin'
