...
# put in Makefilet.coq.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in Makefilet.coq.local
#
###############################################################################
...
#
# There rules can be extended in Makefilet.coq.local
...
# extension points and Makefilet.coq.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in Makefilet.coq.local or include Makefilet.coq.conf)
	@echo 'LOCAL = $(LOCAL)'
	@echo 'COQLIB = $(COQLIB)'
	@echo 'DOCDIR = $(DOCDIR)'
...
# file you can extend the merlin-hook target in Makefilet.coq.local
.merlin:
	$(SHOW)'FILL .merlin'
